			...
			<tr>
				...
				<td>
					...
					<label for="cs2-settings-load_magnific">
						...
						<input type="checkbox" id="cs2-settings-load_magnific" name="<?php echo esc_attr( $option_name."[load_magnific]" ); ?>" value="1" <?php checked($settings_data['load_magnific'], 1); ?> />
						<span><em><?php _e('Magnific Popup - Enable lightbox option.', $textdomain); ?></em></span>
					</label> <br />
					<label for="cs2-settings-load_easing">
						<input type="hidden" name="<?php echo esc_attr( $option_name."[load_easing]" ); ?>" value="0">
						<input type="checkbox" id="cs2-settings-load_easing" name="<?php echo esc_attr( $option_name."[load_easing]" ); ?>" value="1" <?php checked($settings_data['load_easing'], 1); ?> />
						<span><em><?php _e('Easing - Enable easing options.', $textdomain); ?></em></span>
					</label> <br />
				</td>
			</tr>
			<tr>

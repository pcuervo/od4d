...
?>
<div class="cycloneslider cycloneslider-template-text cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?>"
                ...
                <div class="cycloneslider-slide" <?php echo $slide['slide_data_attributes']; ?>>
                    <?php if ($slide['link']!='') : ?>
                        <?php if( '_blank' == $slide['link_target'] ): ?>
                            <a target="_blank" href="<?php echo esc_url( $slide['link'] ); ?>">
                        <?php elseif( 'lightbox' == $slide['link_target'] ): ?>
                            <a class="magnific-pop" href="<?php echo $slide['image_url']; ?>" alt="<?php echo $slide['img_alt'];?>">
                        <?php else: ?>
	...
	<a href="#" class="cycloneslider-prev"><?php _e('Previous', 'cycloneslider'); ?></a>
	<a href="#" class="cycloneslider-next"><?php _e('Next', 'cycloneslider'); ?></a>
	<?php endif; ?>
</div>
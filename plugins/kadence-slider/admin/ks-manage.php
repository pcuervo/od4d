...
class KadenceSliderAdmin {
	...
	public static function ksp_display_page() {
		...
		<div id="kt_ajax_overlay">
			...
			<div class="bubblingG">
				...
				<h1 class="ksp-logo" title="Kadence Slider Pro">
					Kadence Slider Pro
				</h1>
	...
	public static function ksp_display_layerslider() {
		...
		<div class="ksp-slider <?php echo $edit ? 'ksp-edit-slider' : 'ksp-add-slider' ?>">
				<?php if($edit): ?>
					<a class="ksp_back_overview" href="<?php echo admin_url('?page=kadenceslider');?>"><?php _e('Back to sliders overview', 'kadence-slider'); ?></a>

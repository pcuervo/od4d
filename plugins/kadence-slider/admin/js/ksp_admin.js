...
(function($) {
    $(window).load(function() {
        ...
        function ksp_add_text_layer(slide_parent) {
            ...
            $item.closest('.ksp-layers').find('.ksp-layers-list .ksp-layer-font_color').wpColorPicker({
                    change: function(event, ui){
                        var index = $(this).closest('.ksp-layer-settings').index();
                        $(this).closest('.ksp-layers').find('.ksp-slide-editing-area .ksp-layer-wrap:eq(' + index + ') .ksp-layer').css('color', ui.color.toString());
                    }
        ...
        function ksp_add_button_layer(slide_parent) {
            ...
            $item.closest('.ksp-layers').find('.ksp-layers-list .ksp-layer-background_color').wpColorPicker({
                    change: function(event, ui){
                        var index = $(this).closest('.ksp-layer-settings').index();
                        var layer = $(this).closest('.ksp-layers').find('.ksp-slide-editing-area .ksp-layer-wrap:eq(' + index + ') .ksp-layer');
            ...
            $item.closest('.ksp-layers').find('.ksp-layers-list .ksp-layer-border_color').wpColorPicker({
                    change: function(event, ui){
                        var index = $(this).closest('.ksp-layer-settings').index();
                        var layer = $(this).closest('.ksp-layers').find('.ksp-slide-editing-area .ksp-layer-wrap:eq(' + index + ') .ksp-layer');
            ...
            $item.closest('.ksp-layers').find('.ksp-layers-list .ksp-layer-font_hover_color').wpColorPicker({
                    change: function(event, ui){
                        var index = $(this).closest('.ksp-layer-settings').index();
                        var layer = $(this).closest('.ksp-layers').find('.ksp-slide-editing-area .ksp-layer-wrap:eq(' + index + ') .ksp-layer');
            ...
            $item.closest('.ksp-layers').find('.ksp-layers-list .ksp-layer-border_hover_color').wpColorPicker({
                    change: function(event, ui){
                        var index = $(this).closest('.ksp-layer-settings').index();
                        var layer = $(this).closest('.ksp-layers').find('.ksp-slide-editing-area .ksp-layer-wrap:eq(' + index + ') .ksp-layer');
            ...
            $item.closest('.ksp-layers').find('.ksp-layers-list .ksp-layer-background_hover_color').wpColorPicker({
                    change: function(event, ui){
                        var index = $(this).closest('.ksp-layer-settings').index();
                        var layer = $(this).closest('.ksp-layers').find('.ksp-slide-editing-area .ksp-layer-wrap:eq(' + index + ') .ksp-layer');

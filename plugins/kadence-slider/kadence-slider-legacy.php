...
function kadslider_post_init() {
  $slidelabels = array(
    ...
    'singular_name' => __('Kadnece Slider Item', 'kadence-slider'),
...
function kadence_slider_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes[] = array(
				...
				array(
					...
					'type'    => 'select',
					'options' => array(
						array( 'name' => __( 'True', 'kadence-slider' ), 'value' => 'true', ),
						array( 'name' => __( 'False', 'kadence-slider' ), 'value' => 'false', ),
					),
		    	),
				array(
...
$meta_boxes[] = array(
			...
			array(
				    ...
				    'type'        => 'group',
				    'options'     => array(
				        'group_title'   => __( 'Slide {#}', 'kadence-slider' ), // since version 1.1.4, {#} gets replaced by row number
    		...
    		'fields'      => array(
					...
					'type'    => 'select',
					'options' => array(
						array( 'name' => __( 'Center Center', 'kadence-slider' ), 'value' => 'cc', ),
						array( 'name' => __( 'Top Center', 'kadence-slider' ), 'value' => 'tc', ),
						array( 'name' => __( 'Bottom Center', 'kadence-slider' ), 'value' => 'bc', ),
						array( 'name' => __( 'Left Center', 'kadence-slider' ), 'value' => 'lc', ),
						array( 'name' => __( 'Right Center', 'kadence-slider' ), 'value' => 'rc', ),
						array( 'name' => __( 'Top Left', 'kadence-slider' ), 'value' => 'tl', ),
						array( 'name' => __( 'Top Right', 'kadence-slider' ), 'value' => 'tr', ),
						array( 'name' => __( 'Bottom Left', 'kadence-slider' ), 'value' => 'bl', ),
						array( 'name' => __( 'Bottom Right', 'kadence-slider' ), 'value' => 'br', ),
					),
		    	),
			         array(
					...
					'type'    => 'select',
					'options' => array(
					array( 'name' => __( 'fadeIn', 'kadence-slider' ), 'value' => 'fadeIn', ),
		          	array( 'name' => __( 'fadeInDown', 'kadence-slider' ), 'value' => 'fadeInDown', ),
		          	array( 'name' => __( 'fadeInDownBig', 'kadence-slider' ), 'value' => 'fadeInDownBig', ),
		          	array( 'name' => __( 'fadeInLeft', 'kadence-slider' ), 'value' => 'fadeInLeft', ),
		          	array( 'name' => __( 'fadeInLeftBig', 'kadence-slider' ), 'value' => 'fadeInLeftBig', ),
		          	array( 'name' => __( 'fadeInRight', 'kadence-slider' ), 'value' => 'fadeInRight', ),
		           	array( 'name' => __( 'fadeInRightBig', 'kadence-slider' ), 'value' => 'fadeInRightBig', ),
		            array( 'name' => __( 'fadeInUp', 'kadence-slider' ), 'value' => 'fadeInUp', ),
		          	array( 'name' => __( 'fadeInUpBig', 'kadence-slider' ), 'value' => 'fadeInUpBig', ),
		          	array( 'name' => __( 'bounceIn', 'kadence-slider' ), 'value' => 'bounceIn', ),
			          array( 'name' => __( 'bounceInDown', 'kadence-slider' ), 'value' => 'bounceInDown', ),
			          array( 'name' => __( 'bounceInLeft', 'kadence-slider' ), 'value' => 'bounceInLeft', ),
			          array( 'name' => __( 'bounceInRight', 'kadence-slider' ), 'value' => 'bounceInRight', ),
			          array( 'name' => __( 'bounceInUp', 'kadence-slider' ), 'value' => 'bounceInUp', ),
			          array( 'name' => __( 'rotateIn', 'kadence-slider' ), 'value' => 'rotateIn', ),
			          array( 'name' => __( 'rotateInDownLeft', 'kadence-slider' ), 'value' => 'rotateInDownLeft', ),
			          array( 'name' => __( 'rotateInDownRight', 'kadence-slider' ), 'value' => 'rotateInDownRight', ),
			          array( 'name' => __( 'rotateInUpLeft', 'kadence-slider' ), 'value' => 'rotateInUpLeft', ),
			          array( 'name' => __( 'rotateInUpRight', 'kadence-slider' ), 'value' => 'rotateInUpRight', ),
			          array( 'name' => __( 'slideInDown', 'kadence-slider' ), 'value' => 'slideInDown', ),
			          array( 'name' => __( 'slideInLeft', 'kadence-slider' ), 'value' => 'slideInLeft', ),
			          array( 'name' => __( 'slideInRight', 'kadence-slider' ), 'value' => 'slideInRight', ),
			          array( 'name' => __( 'rollIn', 'kadence-slider' ), 'value' => 'rollIn', ),
			          ),
				),
				 array(
					...
					'type'    => 'select',
					'options' => array(
						 array( 'name' => __( 'fadeOut', 'kadence-slider' ), 'value' => 'fadeOut', ),
				         array( 'name' => __( 'fadeOutDown', 'kadence-slider' ), 'value' => 'fadeOutDown', ),
				         array( 'name' => __( 'fadeOutDownBig', 'kadence-slider' ), 'value' => 'fadeOutDownBig', ),
				         array( 'name' => __( 'fadeOutLeft', 'kadence-slider' ), 'value' => 'fadeOutLeft', ),
				         array( 'name' => __( 'fadeOutLeftBig', 'kadence-slider' ), 'value' => 'fadeOutLeftBig', ),
				         array( 'name' => __( 'fadeOutRight', 'kadence-slider' ), 'value' => 'fadeOutRight', ),
				         array( 'name' => __( 'fadeOutRightBig', 'kadence-slider' ), 'value' => 'fadeOutRightBig', ),
				         array( 'name' => __( 'fadeOutUp', 'kadence-slider' ), 'value' => 'fadeOutUp', ),
				         array( 'name' => __( 'fadeOutUpBig', 'kadence-slider' ), 'value' => 'fadeOutUpBig', ),
				          array( 'name' => __( 'bounceOut', 'kadence-slider' ), 'value' => 'bounceOut', ),
				          array( 'name' => __( 'bounceOutDown', 'kadence-slider' ), 'value' => 'bounceOutDown', ),
				          array( 'name' => __( 'bounceOutLeft', 'kadence-slider' ), 'value' => 'bounceOutLeft', ),
				          array( 'name' => __( 'bounceOutRight', 'kadence-slider' ), 'value' => 'bounceOutRight', ),
				          array( 'name' => __( 'bounceOutUp', 'kadence-slider' ), 'value' => 'bounceOutUp', ),
				          array( 'name' => __( 'rotateOut', 'kadence-slider' ), 'value' => 'rotateOut', ),
				          array( 'name' => __( 'rotateOutDownLeft', 'kadence-slider' ), 'value' => 'rotateOutDownLeft', ),
				          array( 'name' => __( 'rotateOutDownRight', 'kadence-slider' ), 'value' => 'rotateOutDownRight', ),
				          array( 'name' => __( 'rotateOutUpLeft', 'kadence-slider' ), 'value' => 'rotateOutUpLeft', ),
				          array( 'name' => __( 'rotateOutUpRight', 'kadence-slider' ), 'value' => 'rotateOutUpRight', ),
				          array( 'name' => __( 'slideOutLeft', 'kadence-slider' ), 'value' => 'slideOutLeft', ),
				          array( 'name' => __( 'slideOutRight', 'kadence-slider' ), 'value' => 'slideOutRight', ),
				          array( 'name' => __( 'slideOutUp', 'kadence-slider' ), 'value' => 'slideOutUp', ),
				          array( 'name' => __( 'rollOut', 'kadence-slider' ), 'value' => 'rollOut', ),
					),
				),
			),
),
...
$meta_boxes[] = array(
				...
				array(
					...
					'default' => '400',
					'options' => array(
						array( 'name' => __( '100', 'kadence-slider' ), 'value' => '100', ),
						array( 'name' => __( '200', 'kadence-slider' ), 'value' => '200', ),
						array( 'name' => __( '300', 'kadence-slider' ), 'value' => '300', ),
						array( 'name' => __( '400', 'kadence-slider' ), 'value' => '400', ),
						array( 'name' => __( '500', 'kadence-slider' ), 'value' => '500', ),
						array( 'name' => __( '600', 'kadence-slider' ), 'value' => '600', ),
						array( 'name' => __( '700', 'kadence-slider' ), 'value' => '700', ),
						array( 'name' => __( '800', 'kadence-slider' ), 'value' => '800', ),
						array( 'name' => __( '900', 'kadence-slider' ), 'value' => '900', ),
					),
		    	),
		    	array(
					...
					'default' => 'normal',
					'options' => array(
						array( 'name' => __( 'Normal', 'kadence-slider' ), 'value' => 'normal', ),
						array( 'name' => __( '1', 'kadence-slider' ), 'value' => '1px', ),
						array( 'name' => __( '2', 'kadence-slider' ), 'value' => '2px', ),
						array( 'name' => __( '3', 'kadence-slider' ), 'value' => '3px', ),
						array( 'name' => __( '4', 'kadence-slider' ), 'value' => '4px', ),
						array( 'name' => __( '5', 'kadence-slider' ), 'value' => '5px', ),
						array( 'name' => __( '6', 'kadence-slider' ), 'value' => '6px', ),
						array( 'name' => __( '7', 'kadence-slider' ), 'value' => '7px', ),
						array( 'name' => __( '8', 'kadence-slider' ), 'value' => '8px', ),
						array( 'name' => __( '9', 'kadence-slider' ), 'value' => '9px', ),
						array( 'name' => __( '10', 'kadence-slider' ), 'value' => '10px', ),
						array( 'name' => __( '11', 'kadence-slider' ), 'value' => '11px', ),
						array( 'name' => __( '12', 'kadence-slider' ), 'value' => '12px', ),
					),
		    	),
				array(
					...
					'options' => array(
						array( 'name' => __( 'Normal', 'kadence-slider' ), 'value' => 'normal', ),
						array( 'name' => __( 'Top and Bottom Border', 'kadence-slider' ), 'value' => 'border', ),
					),
		    	),
				array(
				...
				array(
					...
					'desc' => __('This will align the caption text.', 'kadence-slider'),
					'id'   => $prefix . 'caption_align',
					'type'    => 'select',
					'options' => array(
						array( 'name' => __( 'Center', 'kadence-slider' ), 'value' => 'center', ),
						array( 'name' => __( 'Left', 'kadence-slider' ), 'value' => 'left', ),
						array( 'name' => __( 'Right', 'kadence-slider' ), 'value' => 'right', ),
					),
		    	),
		    	array(
					...
					'type'    => 'select',
					'options' => array(
						array( 'name' => __( 'Show Text Shaddow', 'kadence-slider' ), 'value' => 'true', ),
						array( 'name' => __( 'Hide Text Shaddow', 'kadence-slider' ), 'value' => 'false', ),
					),
		    	),
...
function kadence_slider_admin_scripts() {
  wp_enqueue_style('kadence_slider_admin', KADENCE_SLIDER_URL . 'admin/css/kad-slider-admin.css', false, '200');
			            	...
			            	$slide_image_id = ksp_get_image_id_by_link($slide['image']);
			            	 ...
			            	 ?>
			                      <li> 
			                              ...
			                              <img src="<?php echo esc_url($slide['image']);?>" width="<?php echo esc_attr($slide_image['1']);?>"  height="<?php echo esc_attr($slide_image['2']);?>" class="kt-ratio-img">

<?php get_header(); ?>
      ...
      <div class="main <?php echo kadence_main_class(); ?>" role="main">
		...
		<div class="alert">
		  ...
		  <?php get_search_form(); ?>
		<?php endif; ?>              
		<div id="portfoliowrapper" class="rowtight init-isotope <?php echo esc_attr($pstyleclass);?> <?php echo esc_attr($phoverstyleclass);?>" data-fade-in="<?php echo esc_attr($animate);?>" data-iso-selector=".p-item" data-iso-style="masonry" data-iso-filter="true"> 
		<?php global $wp_query;
					$cat_obj = $wp_query->get_queried_object();
		 			$termslug = $cat_obj->slug;
					query_posts(array( 'paged' => $paged, 'posts_per_page' => $portfolio_items, 'orderby' => 'menu_order', 'order' => 'ASC', 'post_type' => 'portfolio', 'portfolio-tag' => $termslug) );

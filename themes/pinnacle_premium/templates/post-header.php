...
if(!empty($post_header_title)) {
	...
	if(isset($pinnacle['single_post_header_title']) && $pinnacle['single_post_header_title'] == 'custom') {
		...
		if(!empty($pinnacle['post_header_subtitle_text'])){ $bsub = $pinnacle['post_header_subtitle_text'];}
...
<?php do_action("kt_header_overlay"); ?>
	<div class="container">
		<div class="page-header" style="<?php echo $tpadding.' '.$bpadding.' '.$talign;?>">
			<div class="row">
				<div class="col-md-12">
				  	<h1 style="<?php echo $tcolor;?>" class="product_page_title entry-title" itemprop="name"><?php echo $page_title_title; ?></h1>

...
function kad_shortcode_button() {
  $button = '<a href="javascript:void(0);" class="kadence-generator-button button" title="'.__('Insert Shortcode', 'pinnacle').'" data-target="content">';
  $button .= '<i class="dash-icon-generic"></i> '.__('Pinnacle Shortcodes', 'pinnacle').' </a>';
  echo $button;
}
